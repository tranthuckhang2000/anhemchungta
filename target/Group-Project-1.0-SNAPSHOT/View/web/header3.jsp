...
<%--    <link href="<c:url value='/css/popuo-box.css'/>" rel="stylesheet" type="text/css" media="all" />--%>
<%--    <!--     pop-up-box-->--%>
<%--    <link href="<c:url value='/css/menu.css'/>" rel="stylesheet" type="text/css" media="all" />--%>
<%--    <!--     menu style-->--%>
...
<%--    <!-- Custom CSS -->--%>
    ...
    <link href="<c:url value='/css/admin/css/style.css'/>" rel="stylesheet">
    <link href="<c:url value='/css/admin/css/style.min.css'/>" rel="stylesheet">
            ...
            <div class="navbar-header" data-logobg="skin6">
                ...
                <a class="navbar-brand" href="admin/index.html">
                    ...
                    <h1 class="text-center">
                        <a style="color: #d70018" href="admin/index.html" class="font-weight-bold font-tahoma">
                            CellApples
                        </a>
                    </h1>
                </a>
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item pt-2">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="admin/account.html"
                           aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../admin/news.html"
                           aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../admin/managentproduct.html"
                           aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../admin/rate.html"
                           aria-expanded="false">
                    ...
                    <div class="white-box">
                        ...
                        <div class="comment-center">
                            <div class="comment-body d-flex">
                                <div class="user-img"> <img src="../admin/plugins/images/users/pawandeep.jpg" alt="user"
                                                            class="img-circle">
                                </div>
                            ...
                            <div class="comment-body d-flex">
                                <div class="user-img"> <img src="../admin/plugins/images/users/sonu.jpg" alt="user"
                                                            class="img-circle">
                                </div>
                                <div class="mail-contnet">
                            ...
                            <div class="comment-body d-flex border-0">
                                <div class="user-img"> <img src="../admin/plugins/images/users/arijit.jpg" alt="user"
                                                            class="img-circle">
                                </div>
                                <div class="mail-contnet">
...
<script src="<c:url value='../admin/plugins/bower_components/popper.js/dist/umd/popper.min.js'/>"></script>
<script src="<c:url value='../admin/bootstrap/dist/js/bootstrap.min.js'/>"></script>
<script src="<c:url value='../admin/js/app-style-switcher.js'/>"></script>
<script src="<c:url value='../admin/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js'/>"></script>
