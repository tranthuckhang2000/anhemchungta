...
<div class="login-page">
  <div class="form">
    ...
    <form class="register-form" action="dologup" method="post">
      <h3>Đăng Ký</h3>
      <p class="text-danger">${dang-ky-khong-thanh-cong}</p>
      <input type="text" value="${ho_va_ten}" name="ho_va_ten" placeholder="Họ và tên"/>
      ...
      <input type="text" value="${gmail}" name="gmail" placeholder="Địa chỉ email"/>
